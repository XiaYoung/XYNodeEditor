import os
from PySide2.QtCore import QSignalMapper, Qt
from PySide2.QtGui import QKeySequence
from PySide2.QtWidgets import QAction, QDockWidget, QListWidget, QMdiArea, QMessageBox, QWidget

from xynodeeditor.utils import loadStylesheets
...
class CalculatorWindow(NodeEditorWindow):
    ...
    def about(self):
        QMessageBox.about(
            ...
            "<a href='https://www.mathloveart.com'>www.mathloveart.com</a>")
    ...
    def createNodesDock(self):
        ...
        self.listWidget.addItem("Substarct")
